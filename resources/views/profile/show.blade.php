            ...
            <div class="col-md-7">
                ...
                <div class="card p-3 py-4">
                    ...
                    <div class="text-center">
                        ...
                        <img src="https://carnivaltoys.it/8268-large_default/set-dottore--cuffia--mascherina--stetoscopio-riflettore--in-busta-c-cav-.jpg"
                    ...
                    <div class="text-center mt-3">
                        ...
                        <div class="buttons">
                            ...
                            <button class="btn btn-primary px-4 ms-3"
                                onclick="window.location='{{ url('/dashboard') }}'">Home</button>
                        </div>
                    </div>
                </div>
            </div>
